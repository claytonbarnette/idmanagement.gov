...
<table width="75%" style="border:1px solid #c0c0c0;">
  ...
  <tr onclick="location.href='#federal-policies';" style="cursor:pointer;" class="pmlegend">
  ...
  <tr onclick="location.href='#federal-technical-guidance';" style="cursor:pointer;" class="pmlegend">
